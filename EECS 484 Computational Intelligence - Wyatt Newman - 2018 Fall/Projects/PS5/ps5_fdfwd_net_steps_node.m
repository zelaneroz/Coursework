...
% track the current node count
node_count=2;

% save the errors
err=zeros(MAX_NODES,1);
...
while node_count<=MAX_NODES
    ...
    nnodes_layer1=node_count; %try this many interneurons--including bias virtual neuron; experiment with this number
    ...
    EPS=0.4; % tune this value; may also want to vary this during iterations
    MAX_ITERS=2000*node_count;
