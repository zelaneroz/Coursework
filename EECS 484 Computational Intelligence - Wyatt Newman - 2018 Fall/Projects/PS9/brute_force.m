...
ntries=0;
nvalid=0;
% range of values for city2; consider cities 7 through 10 only for c10; generates
            ...
            for c5=2:10
                for c6=2:10
                    for c7=2:10
                        for c8=2:10
                            for c9=2:10
                                % no need to repeat any values used by c2; can consider reverse-order trip
                                for c10=7:10 
                                    ntries=ntries+1;
                                    ...
                                    % need to check if this trip is viable
                                    trip=[1,c2,c3,c4,c5,c6,c7,c8,c9,c10,1]; 
                                    ndistinct=num_cities_visited(trip); 
                                    
                                    % valid tour
                                    if ndistinct==Ncities 
                                        trip
