...
/** An example of a linked list using a non-static nested class for the nodes */
public class List2<T> implements Iterable<T> {
   ...
   */
  public static <S> void printList(List2<S> list) {
  ...
  /** A nested class (non-static) for the nodes of the linked list
    * A non-static element does get access to the generic of the containing class
    */
  private class Node {
    private T element;
    private Node next;
